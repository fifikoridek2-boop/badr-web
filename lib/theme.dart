...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onPrimaryContainer: Color(0xff255022),
      ...
      primaryFixedDim: Color(0xffa2d398),
      onPrimaryFixedVariant: Color(0xff255022),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xff335e2f),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xffa2d398),
      surfaceTint: Color(0xffa2d398),
      onPrimary: Color(0xff0d380e),
      primaryContainer: Color(0xff255022),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      scrim: Color(0xff000000),
      inverseSurface: Color(0xffe0e4da),
      inversePrimary: Color(0xff275124),
      primaryFixed: Color(0xffbef0b2),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xff9fcf95),
